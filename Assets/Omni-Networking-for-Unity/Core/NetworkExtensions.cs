...
namespace Omni.Core
{
	public static class NetworkExtensions
	{
		...
		public static void Spawn(this NetworkIdentity prefab, NetworkPeer peer, Target target = Target.All,
		...
		{
			NetworkManager.SpawnOnServer(prefab, peer).SpawnOnClient(target, deliveryMode, groupId, cacheId, cacheMode, sequenceChannel);
		}
